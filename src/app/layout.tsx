...
export const metadata: Metadata = {
  title: "Spidey's Coffee - Your Friendly Neighborhood Café",
  description: "Experience superhero-inspired coffee blends at Spidey's Coffee. Premium roasts and amazing flavors to fuel your heroic adventures. Order online today!",
  keywords: ["spiderman coffee", "superhero coffee shop", "specialty coffee", "coffee blends", "neighborhood café"],
  openGraph: {
    title: "Spidey's Coffee - Your Friendly Neighborhood Café",
    description: "Experience superhero-inspired coffee blends at Spidey's Coffee. Premium roasts and amazing flavors to fuel your heroic adventures.",
    siteName: "Spidey's Coffee",
    images: [
      {
        url: "https://images.pexels.com/photos/799879/pexels-photo-799879.jpeg?auto=compress&cs=tinysrgb&h=650&w=940",
        alt: "Spidey's Coffee superhero themed coffee shop"
      }
    ],
    type: "website"
  },
  twitter: {
    ...
    title: "Spidey's Coffee - Your Friendly Neighborhood Café",
    description: "Experience superhero-inspired coffee blends at Spidey's Coffee. Premium roasts and amazing flavors to fuel your heroic adventures.",
    images: ["https://images.pexels.com/photos/799879/pexels-photo-799879.jpeg?auto=compress&cs=tinysrgb&h=650&w=940"]
  },
  robots: {
    index: true,
    follow: true
